...
public class TableTestController {
    ...
    @GetMapping("/get")
    public Object get(){
        return new Result(ResultType.SUCCESS.getCode(), "",null);
    }
    @PostMapping("/postTest")
    public Object postTest(String id){
        return new Result(ResultType.SUCCESS.getCode(), id,null);
    }
    @PostMapping("/postJson")
    public Object postJson(@RequestBody UserDto userDto){
        return new Result(ResultType.SUCCESS.getCode(), userDto.getName(),null);
    }
}
